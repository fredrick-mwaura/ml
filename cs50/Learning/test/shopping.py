...
# dataset link : https://drive.google.com/file/d/18ZU9OmY7UTSaMkNNrQFno-KMRAwEUjOT
def load_data(filename): #dataset file name
    """
    ...
    with open("shopping.csv", 'r') as csv_file:
        ...
        for row in reader:
            ...
            revenue.append(1 if row[17] == "TRUE" else 0)
    return (evidence, revenue)

def train_model(evidence, labels, k=3):
    """
...
def evaluate(labels, predictions):
    ...
    `specificity` should be a floating-point value from 0 to 1TEST_SIZE
